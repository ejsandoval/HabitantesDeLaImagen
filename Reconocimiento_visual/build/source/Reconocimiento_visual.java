...
public void draw() {
  ...
  // else if (currentDetectedFaces < prevDetectedFaces && faceDetected) {
  //   if (!possibleOutFace) faceChangeEndTime = currentTime;
  //   possibleOutFace = true;
  // }
  //
  // if (possibleOutFace && currentTime - faceChangeEndTime > faceTime){
  //   faceDetected = false;
  //   possibleOutFace = false;
  //   prevDetectedFaces = currentDetectedFaces;
  //   startTime = 0;
  // }

  elapsed = currentTime - startTime;
  println(faceDetected);
  println(faceChangeEndTime);
